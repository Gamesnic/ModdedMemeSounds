	...
	return !global.ZeresPluginLibrary ? class {
		...
		const plugin = (Plugin, Api) => { try {
			...
			const sounds = [
				...
				{re: /moyai/gmi, file: "longmoyai.mp3", duration: 100},
				{re: /🗿/gmi, file: "longmoyai.mp3", duration: 100},
			];
