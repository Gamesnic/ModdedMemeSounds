...
module.exports = (() => {
	...
	return !global.ZeresPluginLibrary ? class {
		...
		const plugin = (Plugin, Api) => { try {
			...
			const sounds = [
				{re: /amogus/gmi, file: "amogus.mp3", duration: 600},
				{re: /kekw/gmi, file: "kekw.mp3", duration: 550},
			];
